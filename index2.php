...
$initialDelay=10;
$basePath="./img";//use "." for browsing current directory 
...
if(!isset($stylesheet))
  $stylesheet= "<link rel=\"stylesheet\" type=\"text/css\" href=\"$SCRIPT_NAME?css\">"; //$stylesheet="<link rel=\"stylesheet\" type=\"text/css\" href=\"http://localhost/phpshow.css\">"; 
if(!isset($browsertitle))
  $browsertitle="TV Billboard";
if(!isset($slidetitle))
...
if(!isset($autoplay)){
  if(isset($hideControlElements)) // deleted row "&&($hideControlElements)" for enable autoplay
...
if($useFading)
  ...
  $timeOutFunc="gonext()";
echo "$doctype<html><head>$encoding<meta name=\"info\" content=\"\">
